...
public class XMLMapperBuilder extends BaseBuilder {
  ...
  private ResultMap resultMapElement(XNode resultMapNode, List<ResultMapping> additionalResultMappings, Class<?> enclosingType) {
    ...
    **
    ...
    Class<?> typeClass = resolveClass(type);  // 解析 type 对应的类
    if (typeClass == null) {
    ...
    } catch (IncompleteElementException  e) {// 解析失败，添加到 configuration 中
   ...
   *    <case value="2" resultMap="draftPost"/>
        <case value="1">
  ...
  private String processNestedResultMappings(XNode context, List<ResultMapping> resultMappings, Class<?> enclosingType) {
    if ("association".equals(context.getName())
      ...
      if (context.getStringAttribute("select") == null) {
        ...
        ResultMap resultMap = resultMapElement(context, resultMappings, enclosingType);  //解析并返回resultMap
  ...
  private void bindMapperForNamespace() {
    ...
    if (namespace != null) {
      ...
      try {  //  获得 Mapper 映射配置文件对应的 Mapper 接口，实际上类名就是 namespace 。嘿嘿，这个是常识
